...
\subsubsection{Protocol's Mission}
...
\subsubsection{Protocol's Vision}
...
\subsubsection{Protocol's Three Guiding Principles}
	...
	\item[Communication]
	      ...
	      \begin{itemize}
		      \item Avoid conflating facts with opinion by clearly separating
		            \begin{description}
			            \item[Evidence] presented neutrally and supported by citations;
			            \item[Analysis] interpretation of what the evidence suggests;
			            \item[Opinion or recommendation] normative judgment which must be clearly identified as ``in this author's own view.''
		            \end{description}
