% ***************************************************
% Protocol Policy Lab - shared LaTeX preamble
% ***************************************************
% Loaded by every root document (ResearchManual.tex, MainInquiry.tex, future
% thesis roots). One file, no duplicate package loads, no duplicate macros.
% Conflicts resolved in favour of the Research Manual side (mathsf for
% distributions, mathcal for filtrations) so the typography is consistent.
...
% Wraps drafter guidance in a soft blue box. To suppress all instructional
% matter for a final submission, redefine the env to \comment / \endcomment
% in the document root after loading this file.
\newmdenv[
...
% ----- number sets, probability spaces ---------------------------------------
...
% ----- distribution macros (mathsf for visual distinction) -------------------
...
% ----- tcolorbox styles + theorem boxes --------------------------------------
\tcbset{
    academicbox/.style={
...
% ----- plain amsthm environments (definition/condition; keep alongside tcb) --
...
% ----- cleveref aliases for tcolorbox theorems -------------------------------
